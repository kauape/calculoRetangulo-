package com.example.arearetangulo;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.button_calcular) {
            if ("".equals(this.mViewHolder.edit_altura.getText().toString()) ||
                "".equals(this.mViewHolder.edit_largura.getText().toString())) {
                ...
                this.mViewHolder.text_result.setText(String.valueOf(resposta));
